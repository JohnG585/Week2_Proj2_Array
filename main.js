...
document.getElementById("q1").innerHTML= words;
// 2. Add an additional item to the beginning of your array.
words.unshift('NorthEast')
document.getElementById("q2").innerHTML = words;
// 3. Remove the second and third items in your array.
words.splice(2,2)
document.getElementById("q3").innerHTML = words;
// 4. Add two new items after the second item.
words.splice(2,0,"South East", "North West")
document.getElementById("q4").innerHTML = words;
// 5. Log to the console: 'The current length of the array is....' using the .length method
console.log("The current Length of the array is "+words.length);
document.getElementById("q5").innerHTML="The current Length of the array is "+words.length;
...
var goodThings=things.join();
document.getElementById("q7").innerHTML=goodThings;
...
console.log("what is it: ", lastItem);
